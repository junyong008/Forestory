...
@Database(entities = [PostEntity::class, TagEntity::class, CommentEntity::class], version = 1, exportSchema = false)
@TypeConverters(Converter::class)
abstract class ForestoryDatabase: RoomDatabase() {
    abstract fun postWithTagsAndCommentsDao(): PostWithTagsAndCommentsDao
